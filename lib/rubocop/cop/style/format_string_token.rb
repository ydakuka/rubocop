...
module RuboCop
  module Cop
    module Style
      ...
      #   # In `aggressive` mode, offenses are registered for all strings,
      #   # but autocorrection is only applied in a known formatting context.
      #
      #   # bad - offense registered, but not autocorrected
      #   "%{greeting}"
      #   foo("%{greeting}")
      #
      #   # bad - autocorrected
      ...
      #   # In `conservative` mode, only strings given to a known formatting
      #   # method are checked. Offenses are registered and autocorrected.
      #
      #   # good
      #   "%{greeting}"
      #   foo("%{greeting}")
